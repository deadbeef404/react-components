define(function(require) {
    ...
    return {
        ...
        getQuickFilter: function() {
            ...
            return React.createElement("input", {ref: "filter", className: "quick-filter", type: "search", placeholder: this.props.quickFilterPlaceholder, value: this.state.quickFilterValue, onChange: this.handleQuickFilterChange});
        },
        ...
        getTableData: function(val, meta, hoverValue, index, online) {
            ...
            return (
                React.createElement("td", {className: "status", key: 'td-' + index}, 
