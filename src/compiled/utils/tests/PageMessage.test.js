define(function(require) {
    ...
    describe('PageMessage', function() {
        ...
        beforeEach(function() {
            ...
            pageMessage = TestUtils.renderIntoDocument(React.createElement(PageMessage, React.__spread({},  props)));
        });
        ...
        describe('componentDidMount', function() {
            ...
            it('should not call dismiss with animation after the set duration if the duration is 0', function() {
                pageMessage = TestUtils.renderIntoDocument(React.createElement(PageMessage, {message: "Message", type: "message", duration: 0}));
                spyOn(pageMessage, 'dismiss');
        ...
        describe('getMessageMarkup', function() {
            ...
            it('should not display a close icon if one was not set', function() {
                pageMessage = TestUtils.renderIntoDocument(React.createElement(PageMessage, {message: "Message", type: "message"}));
            ...
            it('should display a close icon if one was set', function() {
                pageMessage = TestUtils.renderIntoDocument(React.createElement(PageMessage, {message: "Message", type: "message", closeIcon: "closeIconClass"}));
            ...
            it('should display an icon if one was set', function() {
                pageMessage = TestUtils.renderIntoDocument(React.createElement(PageMessage, {message: "Message", type: "message", icon: "iconClass"}));
