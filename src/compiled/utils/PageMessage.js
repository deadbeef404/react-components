define(function(require) {
    ...
    var PageMessage = React.createClass({displayName: "PageMessage",
        ...
        render: function() {
            return (
                React.createElement("div", {className: "page-message"}, 
                    React.createElement(ReactCSSTransitionGroup, {transitionName: "message", transitionAppear: true}, 
        ...
        getMessageMarkup: function() {
            ...
            var closeIcon = this.props.closeIcon ? React.createElement("i", {className: this.props.closeIcon + ' close', onClick: this.dismiss.bind(this, false)}) : null;
            ...
            return (
                React.createElement("div", {className: "message " + this.props.type}, 
                    closeIcon, 
                    React.createElement("span", null, icon, " ", this.props.message)
                )
            );
        },
